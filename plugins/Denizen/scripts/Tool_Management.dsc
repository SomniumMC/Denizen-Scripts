...
Tool_Management_Event_Main:
    ...
    events:
        ...
        - if <[tool_bench].flag[tool_bench].get[clickers].keys.size> == 0:
            ...
            - wait 10t
            - drop item:<inventory[tool_bench_inv_<[tool_bench].uuid>].slot[1]> quantity:1 location:<[tool_bench].flag[tool_bench.location].above[1].center>
            - inventory adjust slot:1 destination:<inventory[tool_bench_inv_<[tool_bench].uuid>]> o:air
