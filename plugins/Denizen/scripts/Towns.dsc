...
Town_Form_Task:
    ...
    - execute "town set perm itemuse on" as_op
    - execute "town set perm switch on" as_op
...
Town_Flag_Cleanup:
  ...
  - flag server town.<[flag].flag[town_name]>.claiming:!
...
Town_Flag_Claim:
  ...
  - narrate targets:<player.location.find_players_within[100]> "<gold><bold><[flag].flag[town_name]><aqua>, has claimed a chunk!"
  - run Town_Flag_Cleanup def:<[flag]>
