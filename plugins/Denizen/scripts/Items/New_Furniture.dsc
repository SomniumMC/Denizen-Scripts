...
Furniture_Config_GUI:
  ...
  - [GUINULL] [] [] [] [red_concrete[display=<red>Backward]] [green_concrete[display=<red>Left]] [green_concrete[display=<green>Up]] [green_concrete[display=<blue>Right]] [green_concrete[display=<green>Forward]]
