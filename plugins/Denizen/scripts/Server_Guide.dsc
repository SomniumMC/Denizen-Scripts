...
Server_Guide_Bookscript:
    ...
    - <gold><bold>     Foreword<&co><n><n><gray><black>Hello everyone, this book is here to explain out our custom systems our server uses. If you have any questions that aren't explained out very well then please ask in our <gold><bold><element[Discord].on_click[https://discord.gg/QX2zHyNaMs].type[open_url]><black>.
    ...
    - <gold><bold>Carpentry<&co> <dark_green><element[★].on_hover[Contents].on_click[4].type[change_page]><n><n><gray><black>In order to make certain resources or further crafting stations then you will need to craft a <red>Carpentry Bench <black>alongside a <blue>Work Bench<black>. In order to use the <red>Carpentry Bench <gray><black>you need to link it to a nearby <blue>Work Bench <gray><black>by sneak right-
    ...
    - <gray><black>Here you can craft things by selecting the category in the GUI and then select an item. It will then travel back to the original-
