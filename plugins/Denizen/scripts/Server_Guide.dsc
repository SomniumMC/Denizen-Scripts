...
Server_Guide_Bookscript:
    ...
    #Here you can craft things by selecting the category at the top of the GUI and then select an item. It will then travel back to the original-
