...
Server_Guide:
    ...
    mechanisms:
      components_patch:
        item_model: string:books:learning_guide
    lore:
...
Server_Guide_Bookscript:
    ...
    signed: true
    text:
    - <n><n><n>         <light_purple><bold>Server                Guide<n><n>         <gray>for<n><n><red><bold>     SomniumMC<n><n><n><n>          <white><black>by<n>         <gray><italic>Unknown
    - <gold><bold>     Foreword<&co><n><n><gray><black>Hello everyone, this book is here to explain out our custom systems our server uses. If you have any questions that aren't explained out very well then please ask in our <gold><bold><element[Discord].on_click[https://discord.gg/QX2zHyNaMs].type[open_url].on_hover[Link to Discord]><black>.
    ...
    - <gold><bold>     Contents<&co><n><n><gray><black><bold>⚫ <gold><bold><element[Custom Crafting].on_hover[Page 6].on_click[6].type[change_page]><n><n><gray><black><bold>⚫ <gold><bold><element[Butchery].on_hover[Page 10].on_click[10].type[change_page]><n><n><gray><black><bold>⚫ <gold><bold><element[Cooking].on_hover[Page 12].on_click[12].type[change_page]><n><n><gray><black><bold>⚫ <gold><bold><element[Farming].on_hover[Page 15].on_click[15].type[change_page]><n><n><gray><black><bold>⚫ <gold><bold><element[Brewing].on_hover[Currently Writing].strikethrough>
    - <gray><black><bold>⚫ <gold><bold><element[Fishing].on_hover[Page 17].on_click[17].type[change_page]><n><n><gray><black><bold>⚫ <gold><bold><element[Furniture].on_hover[Page 18].on_click[18].type[change_page]>
    - <gold><bold>Custom Crafting<&co> <dark_green><element[★].on_hover[Contents].on_click[4].type[change_page]><n><n><gray><black>In order to make certain resources or further crafting stations then you will need to craft a <red>Carpentry Bench <black>alongside a <blue>Work Bench<black>. In order to use the <red>Carpentry Bench <gray><black>you need to link it to a nearby <blue>Work Bench <gray><black>by sneak right-
    - <gray><black>clicking the <blue>Work Bench <gray><black>while holding a <green>Configuration Wrench<gray><black>. Doing this will select the workbench, you just need to right click the <red>Carpentry Bench <gray><black>and select <light_purple>Link Craftstation<gray><black>. Once linked you can interact with the <red>Carpentry Bench <gray><black>to open the GUI.
    - <gray><black>Here you can craft things by selecting the category in the GUI, this will open a futher GUI with all the items in that category. In this category GUI if you have the ingredients in your inventory and you click on an item it'll craft the recipe.
    - <gray><black>As a tip, a lot basic recipes like the <red>Carpentry Bench<gray><black> and <blue>Work Bench<gray><black> can be made in the basic <green>Crafting Table<gray><black>. This is to help new players get started with the custom crafting system.
    ...
    - <gray><black>that is not all you can do with cooking. By crafting a <green>Kitchen Counter<gray><black> or a <green>Stove<gray><black> you can open a cooking GUI. Here you can combine ingredients to make unique food dishes that give different effects and benefits. This replaces normal food recipes to encourage players to explore the cooking system.
    - <gray><black>To see what recipes are available, you can place a Pressure Plate on top of a furnace or kitchen counter and interact with it. This will open a recipe book GUI that shows all the available recipes you can make with the system.
    ...
    - <gold><bold>Fishing<&co> <dark_green><element[★].on_hover[Contents].on_click[4].type[change_page]><n><n><gray><black>This has gotten an overhaul by introducing custom drop tables ranging from catching raw ores, equipment, to custom fish. Players can also craft custom durability rods with the <gold><bold><element[Carpentry Bench].on_hover[Page 6].on_click[6].type[change_page]><gray><black>
