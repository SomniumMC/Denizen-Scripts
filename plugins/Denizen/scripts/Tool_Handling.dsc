...
update_item_task:
  ...
  - if <[2].has_flag[food]||null>:
    - if <[2].flag[food]> > 0:
      ...
      - define test t
  #- if <[2].has_flag[smelting]>:
  #  - define lore "<[lore]><n><light_purple>Can be added to a Furnace."
  #  - define test t
  #- if <[2].has_flag[ingredient]>:
  #  - define lore "<[lore]><n><light_purple>Can be added to a Crafting Table."
  #  - define test t
  #- if <[2].has_flag[slot]>:
  #  - define lore "<[lore]><n><red>Slot: <[2].flag[slot]>"
  #  - if <[2].has_flag[given_flag]>:
  #    - define lore "<[lore]><n><light_purple>Static: <[2].flag[display_given]>"
  #  - define test t
